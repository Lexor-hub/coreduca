    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-6 max-w-md mx-auto">
            ...
            >
                ...
                <p className="text-sm text-muted-foreground mt-2">Aprenda coreano com diversão</p>
            </motion.div>
            ...
            >
                ...
                <Button
                    type="submit"
                    className="w-full h-12 rounded-xl bg-[var(--color-coreduca-blue)] text-white font-bold text-base"
                    disabled={loading}
                >
            ...
            <p className="text-sm text-muted-foreground mt-6">
                Não tem conta?{' '}
                <Link href="/register" className="text-[var(--color-coreduca-blue)] font-semibold hover:underline">
                    Criar conta
                </Link>
            </p>
        </div>
