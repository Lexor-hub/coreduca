    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-6 max-w-md mx-auto">
            ...
            >
                ...
                <p className="text-sm text-muted-foreground mt-1">Comece sua jornada no coreano</p>
            </motion.div>
            ...
            <p className="text-sm text-muted-foreground mt-6">
                Já tem conta?{' '}
                <Link href="/login" className="text-[var(--color-coreduca-blue)] font-semibold hover:underline">
                    Fazer login
                </Link>
            </p>
        </div>
